const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Home-Elw_bb0B.js","./vendor-vue-DY_GSZI0.js","./useScrollAnimation-0ZaLSmnP.js","./vendor-html2pdf-BTG5XtWv.js","./vendor-hljs-DIo1dxxj.js","./Home-DFLYG4Jy.css","./Articles-CSfdq66c.js","./Articles-CXGYQ4Wp.css","./ArticleDetail-DXJBkPoI.js","./vendor-marked-JKvyS0Pp.js","./ArticleDetail-rYNDFEVR.css","./Projects-QVMtzIPR.js","./Resume-DngdInVq.js","./NotFound-DAwgc48u.js"])))=>i.map(i=>d[i]);
import{w as N,o as L,a as E,c as l,b as e,d,e as u,F as w,r as k,T as C,n as _,f as V,t as m,u as f,g as b,h as A,i as P,j as O,k as c,l as T,m as M,p as B,q as G,s as H,v as W}from"./vendor-vue-DY_GSZI0.js";import{_ as g}from"./vendor-html2pdf-BTG5XtWv.js";import"./vendor-hljs-DIo1dxxj.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const h of s.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&a(h)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();const y={name:"Alex Chen",title:"全栈开发工程师",avatar:"/avatar.jpg",bio:"热爱技术，专注于 Web 全栈开发、云原生架构和 AI 应用。拥有 5 年以上的开发经验，善于将复杂的技术问题转化为优雅的解决方案。追求代码质量与用户体验的极致平衡。",email:"2651466619@qq.com",github:"https://github.com/Ly78-ad?tab=repositories",location:"中国·陕西",availability:"开放合作"},fe=["Vue.js","React","TypeScript","Node.js","Python","Go","Docker","Kubernetes","AWS","PostgreSQL","MongoDB","Redis","GraphQL","Nginx","Linux","Git","CI/CD","TailwindCSS","Next.js","Nuxt.js"],ye=[{id:"vue3-composition-api",title:"Vue 3 Composition API 深度解析与实战指南",summary:"从 Options API 到 Composition API 的思维转换，深入理解 ref、reactive、computed、watch 等核心概念，以及在实际项目中的最佳实践。",content:`
...
Docker Compose 让本地开发环境变得一致且可复现，大幅减少"在我机器上能跑"的问题。
    `,date:"2024-11-20",category:"DevOps",tags:["Docker","Compose","微服务","开发环境"],readTime:"12 分钟",views:1950,likes:165}],ve=[{id:"cloud-music",name:"CloudMusic 云音乐播放器",description:"基于 Vue 3 + TypeScript 开发的在线音乐播放器，支持歌词同步、播放列表管理、个性化推荐等功能。采用 Pinia 状态管理，后端使用 Node.js + MongoDB。",techStack:["Vue 3","TypeScript","Pinia","Node.js","MongoDB","WebSocket"],cover:"https://images.unsplash.com/photo-1614680376593-902f74cf0d41?w=600&h=400&fit=crop",demo:"https://demo.example.com/cloud-music",github:"https://github.com/alexchen/cloud-music",featured:!0},{id:"task-flow",name:"TaskFlow 任务管理平台",description:"企业级项目管理工具，支持看板视图、甘特图、团队协作、实时通知。使用 React + Next.js 构建，集成 WebSocket 实时通信和 Redis 缓存。",techStack:["React","Next.js","Prisma","PostgreSQL","Redis","WebSocket"],cover:"https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=600&h=400&fit=crop",demo:"https://demo.example.com/task-flow",github:"https://github.com/alexchen/task-flow",featured:!0},{id:"ai-chat-assistant",name:"AI Chat Assistant",description:"基于大语言模型的智能对话助手，支持多轮对话、上下文记忆、流式输出。使用 Go 构建高性能后端，前端采用 React + TailwindCSS。",techStack:["React","Go","OpenAI API","gRPC","Docker","Kubernetes"],cover:"https://images.unsplash.com/photo-1677442136019-21780ecad995?w=600&h=400&fit=crop",demo:"https://demo.example.com/ai-chat",github:"https://github.com/alexchen/ai-chat-assistant",featured:!0},{id:"devops-dashboard",name:"DevOps 监控面板",description:"实时监控服务器状态、CI/CD 流水线、日志分析的统一面板。支持自定义告警规则、多数据源聚合查询。使用 ECharts 进行数据可视化。",techStack:["Vue 3","ECharts","Go","Prometheus","Grafana","Docker"],cover:"https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop",demo:"https://demo.example.com/devops-dash",github:"https://github.com/alexchen/devops-dashboard",featured:!1},{id:"ecommerce-platform",name:"ShopNext 电商平台",description:"全栈电商解决方案，包含商品管理、购物车、订单系统、支付集成。采用 Next.js SSR 优化 SEO，Stripe 集成支付，支持多语言国际化。",techStack:["Next.js","TypeScript","Stripe","Prisma","PostgreSQL","AWS S3"],cover:"https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&h=400&fit=crop",demo:"https://demo.example.com/shop-next",github:"https://github.com/alexchen/shop-next",featured:!1},{id:"blog-cms",name:"Headless Blog CMS",description:"无头博客 CMS 系统，提供 RESTful API 和 GraphQL 接口，支持 Markdown 编辑、标签分类、SEO 优化。管理后台使用 Ant Design。",techStack:["Nuxt.js","Ant Design","GraphQL","Node.js","MongoDB","Redis"],cover:"https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=600&h=400&fit=crop",demo:"https://demo.example.com/blog-cms",github:"https://github.com/alexchen/blog-cms",featured:!1},{id:"real-time-collab",name:"RealSync 实时协作文档",description:"基于 CRDT 算法的实时协作文档编辑器，支持多人同时编辑、光标追踪、版本历史回溯。使用 WebSocket 和 OT 算法实现毫秒级同步。",techStack:["Vue 3","TypeScript","Yjs","WebSocket","Node.js","Redis"],cover:"https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=600&h=400&fit=crop",demo:"https://demo.example.com/realsync",github:"https://github.com/alexchen/real-sync",featured:!0},{id:"video-streaming",name:"StreamHub 视频流媒体平台",description:"全栈视频流媒体平台，支持视频上传、转码、HLS 自适应码率播放、弹幕互动。使用 FFmpeg 转码和 CDN 加速分发。",techStack:["React","Go","FFmpeg","HLS","PostgreSQL","MinIO"],cover:"https://images.unsplash.com/photo-1536240478700-b869070f9279?w=600&h=400&fit=crop",demo:"https://demo.example.com/streamhub",github:"https://github.com/alexchen/stream-hub",featured:!1},{id:"smart-iot",name:"SmartHome IoT 控制中心",description:"智能家居 IoT 控制平台，支持设备管理、自动化场景、实时数据监控。使用 MQTT 协议通信，Grafana 可视化数据面板。",techStack:["Next.js","MQTT","Python","InfluxDB","Grafana","Docker"],cover:"https://images.unsplash.com/photo-1558002038-1055907df827?w=600&h=400&fit=crop",demo:"https://demo.example.com/smart-home",github:"https://github.com/alexchen/smart-home-iot",featured:!1},{id:"data-pipeline",name:"DataFlow 数据处理流水线",description:"可视化数据 ETL 流水线平台，支持拖拽式构建数据处理流程，内置 50+ 数据转换组件，支持定时调度和实时监控。",techStack:["Vue 3","Python","Apache Airflow","ClickHouse","Redis","Docker"],cover:"https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=600&h=400&fit=crop",demo:"https://demo.example.com/dataflow",github:"https://github.com/alexchen/data-flow",featured:!1}],xe={education:[{school:"华南理工大学",degree:"计算机科学与技术 · 硕士",period:"2017 - 2020",gpa:"GPA 3.8/4.0"},{school:"武汉大学",degree:"软件工程 · 学士",period:"2013 - 2017",gpa:"GPA 3.6/4.0"}],experience:[{company:"字节跳动",role:"高级前端开发工程师",period:"2022 - 至今",highlights:["主导抖音创作者平台前端架构重构，性能提升 40%","设计并实现微前端框架，支撑 20+ 子应用协同运行","建立前端监控体系，错误率降低 60%","指导初级开发者，提升团队整体代码质量"]},{company:"腾讯",role:"全栈开发工程师",period:"2020 - 2022",highlights:["负责微信小程序开发框架的维护和优化","设计并实现高性能 Node.js BFF 层，QPS 达到 5000+","推动团队 TypeScript 迁移，覆盖率从 0% 提升到 85%","参与开源项目贡献，获得 2000+ GitHub Stars"]}],skills:{languages:["JavaScript/TypeScript","Python","Go","SQL"],frontend:["Vue.js (Expert)","React (Expert)","Next.js","Nuxt.js","TailwindCSS"],backend:["Node.js","Express","NestJS","Gin","FastAPI"],database:["PostgreSQL","MongoDB","Redis","MySQL"],devops:["Docker","Kubernetes","AWS","CI/CD","Nginx"],tools:["Git","Linux","VS Code","Figma","Postman"]},certifications:["AWS Solutions Architect Associate","Google Cloud Professional Cloud Developer","Kubernetes Certified Application Developer (CKAD)"]},U=(p,i)=>{const n=p.__vccOpts||p;for(const[a,t]of i)n[a]=t;return n},F={class:"min-h-screen flex flex-col"},K={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},Q={class:"flex items-center justify-between h-16"},q={class:"hidden md:flex items-center gap-1"},$={class:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},Y={key:0,"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h16M4 18h16"},z={key:1,"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"},J={key:0,class:"md:hidden bg-cyber-surface/95 backdrop-blur-lg border-b border-cyber-border"},X={class:"px-4 py-3 space-y-1"},Z={class:"flex-1 pt-16"},ee={class:"border-t border-cyber-border bg-cyber-surface/50"},te={class:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"},oe={class:"grid grid-cols-1 md:grid-cols-3 gap-8"},re={class:"space-y-2"},se={class:"space-y-2 text-sm text-cyber-muted"},ae={class:"flex gap-3 mt-3"},ie=["href"],ne=["href"],ce=["href"],pe={class:"flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-cyber-muted"},le={__name:"App",setup(p){const i=O(),n=P(!1),a=P(!1),t=P(!1),s=[{path:"/",label:"首页"},{path:"/articles",label:"技术文章"},{path:"/projects",label:"项目展示"},{path:"/resume",label:"个人简历"}];function h(S){return S==="/"?i.path==="/":i.path.startsWith(S)}function x(){n.value=window.scrollY>20,t.value=window.scrollY>400}function j(){window.scrollTo({top:0,behavior:"smooth"})}return N(()=>i.path,()=>{a.value=!1}),L(()=>{window.addEventListener("scroll",x,{passive:!0}),x()}),E(()=>{window.removeEventListener("scroll",x)}),(S,o)=>{const v=A("router-link"),I=A("router-view");return c(),l("div",F,[e("nav",{class:_(["fixed top-0 left-0 right-0 z-50 transition-all duration-300",n.value?"bg-cyber-bg/90 backdrop-blur-lg border-b border-cyber-border shadow-lg shadow-cyber-primary/5":"bg-transparent"])},[e("div",K,[e("div",Q,[d(v,{to:"/",class:"flex items-center gap-2 group"},{default:u(()=>[...o[2]||(o[2]=[e("div",{class:"w-8 h-8 rounded-lg bg-cyber-primary/20 border border-cyber-primary/40 flex items-center justify-center group-hover:bg-cyber-primary/30 transition-colors"},[e("span",{class:"text-cyber-primary font-display text-sm font-bold"},m("</>"))],-1),e("span",{class:"font-display text-lg font-bold tracking-wider text-cyber-text group-hover:text-cyber-primary transition-colors"},[b(" TECH"),e("span",{class:"text-cyber-primary"},"BLOG")],-1)])]),_:1}),e("div",q,[(c(),l(w,null,k(s,r=>d(v,{key:r.path,to:r.path,class:_(["px-4 py-2 rounded-lg text-sm font-medium tracking-wide transition-all duration-300",h(r.path)?"text-cyber-primary bg-cyber-primary/10 border border-cyber-primary/30":"text-cyber-muted hover:text-cyber-primary hover:bg-cyber-primary/5"])},{default:u(()=>[b(m(r.label),1)]),_:2},1032,["to","class"])),64))]),e("button",{class:"md:hidden p-2 rounded-lg text-cyber-muted hover:text-cyber-primary hover:bg-cyber-primary/10 transition-colors",onClick:o[0]||(o[0]=r=>a.value=!a.value),"aria-label":"Toggle menu"},[(c(),l("svg",$,[a.value?(c(),l("path",z)):(c(),l("path",Y))]))])])]),d(C,{name:"slide-down"},{default:u(()=>[a.value?(c(),l("div",J,[e("div",X,[(c(),l(w,null,k(s,r=>d(v,{key:r.path,to:r.path,class:_(["block px-4 py-2.5 rounded-lg text-sm font-medium transition-all",h(r.path)?"text-cyber-primary bg-cyber-primary/10":"text-cyber-muted hover:text-cyber-primary hover:bg-cyber-primary/5"]),onClick:o[1]||(o[1]=me=>a.value=!1)},{default:u(()=>[b(m(r.label),1)]),_:2},1032,["to","class"])),64))])])):T("",!0)]),_:1})],2),e("main",Z,[d(I,null,{default:u(({Component:r})=>[d(C,{name:"fade",mode:"out-in"},{default:u(()=>[(c(),M(B(r)))]),_:2},1024)]),_:1})]),e("footer",ee,[e("div",te,[e("div",oe,[o[5]||(o[5]=V('<div data-v-fbb2998e><div class="flex items-center gap-2 mb-4" data-v-fbb2998e><div class="w-8 h-8 rounded-lg bg-cyber-primary/20 border border-cyber-primary/40 flex items-center justify-center" data-v-fbb2998e><span class="text-cyber-primary font-display text-sm font-bold" data-v-fbb2998e>&lt;/&gt;</span></div><span class="font-display text-lg font-bold tracking-wider" data-v-fbb2998e> TECH<span class="text-cyber-primary" data-v-fbb2998e>BLOG</span></span></div><p class="text-cyber-muted text-sm leading-relaxed" data-v-fbb2998e> 探索前沿技术，分享开发经验，构建更好的数字世界。 </p></div>',1)),e("div",null,[o[3]||(o[3]=e("h3",{class:"font-display text-sm font-semibold tracking-wider uppercase text-cyber-text mb-4"},"快速链接",-1)),e("div",re,[(c(),l(w,null,k(s,r=>d(v,{key:r.path,to:r.path,class:"block text-sm text-cyber-muted hover:text-cyber-primary transition-colors"},{default:u(()=>[b(m(r.label),1)]),_:2},1032,["to"])),64))])]),e("div",null,[o[4]||(o[4]=e("h3",{class:"font-display text-sm font-semibold tracking-wider uppercase text-cyber-text mb-4"},"联系方式",-1)),e("div",se,[e("p",null,"📧 "+m(f(y).email),1),e("p",null,"📍 "+m(f(y).location),1),e("div",ae,[e("a",{href:f(y).github,target:"_blank",class:"text-cyber-muted hover:text-cyber-primary transition-colors"},"GitHub",8,ie),e("a",{href:f(y).linkedin,target:"_blank",class:"text-cyber-muted hover:text-cyber-primary transition-colors"},"LinkedIn",8,ne),e("a",{href:f(y).twitter,target:"_blank",class:"text-cyber-muted hover:text-cyber-primary transition-colors"},"Twitter",8,ce)])])])]),o[7]||(o[7]=e("div",{class:"glow-line my-8"},null,-1)),e("div",pe,[e("p",null,"© "+m(new Date().getFullYear())+" TechBlog. All rights reserved.",1),o[6]||(o[6]=e("p",{class:"font-mono text-xs"},[b(" Built with "),e("span",{class:"text-cyber-primary"},"Vue 3"),b(" + "),e("span",{class:"text-cyber-secondary"},"TailwindCSS")],-1))])])]),d(C,{name:"fade"},{default:u(()=>[t.value?(c(),l("button",{key:0,onClick:j,class:"fixed bottom-8 right-8 z-40 w-12 h-12 rounded-xl bg-cyber-surface/80 backdrop-blur-md border border-cyber-border hover:border-cyber-primary/50 text-cyber-primary flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:shadow-cyber-primary/20 hover:-translate-y-1","aria-label":"返回顶部"},[...o[8]||(o[8]=[e("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 10l7-7m0 0l7 7m-7-7v18"})],-1)])])):T("",!0)]),_:1})])}}},de=U(le,[["__scopeId","data-v-fbb2998e"]]),ue=[{path:"/",name:"Home",component:()=>g(()=>import("./Home-Elw_bb0B.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url),meta:{title:"首页"}},{path:"/articles",name:"Articles",component:()=>g(()=>import("./Articles-CSfdq66c.js"),__vite__mapDeps([6,1,2,3,4,7]),import.meta.url),meta:{title:"技术文章"}},{path:"/article/:id",name:"ArticleDetail",component:()=>g(()=>import("./ArticleDetail-DXJBkPoI.js"),__vite__mapDeps([8,1,9,4,3,10]),import.meta.url),meta:{title:"文章详情"}},{path:"/projects",name:"Projects",component:()=>g(()=>import("./Projects-QVMtzIPR.js"),__vite__mapDeps([11,2,1,3,4]),import.meta.url),meta:{title:"项目展示"}},{path:"/resume",name:"Resume",component:()=>g(()=>import("./Resume-DngdInVq.js"),__vite__mapDeps([12,3,4,2,1]),import.meta.url),meta:{title:"个人简历"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:()=>g(()=>import("./NotFound-DAwgc48u.js"),__vite__mapDeps([13,1,3,4]),import.meta.url),meta:{title:"页面未找到"}}],R=G({history:H(),routes:ue,scrollBehavior(p,i,n){return p.hash?{el:p.hash,behavior:"smooth",top:80}:n||{top:0,behavior:"smooth"}}});R.beforeEach(p=>{document.title=`${p.meta.title||"页面"} | TechBlog`});const D=W(de);D.use(R);D.mount("#app");export{U as _,ye as a,ve as b,y as p,xe as r,fe as t};
